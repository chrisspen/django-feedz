...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.article_content'
        db.add_column(u'djangofeeds_post', 'article_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.article_content'
        db.delete_column(u'djangofeeds_post', 'article_content')
