...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.summary_detail_link_regex'
        db.add_column(u'djangofeeds_feed', 'summary_detail_link_regex',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.summary_detail_link_regex'
        db.delete_column(u'djangofeeds_feed', 'summary_detail_link_regex')
