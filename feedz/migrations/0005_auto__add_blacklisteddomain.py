...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlacklistedDomain'
        db.create_table(u'djangofeeds_blacklisteddomain', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=150, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'djangofeeds', ['BlacklistedDomain'])


    def backwards(self, orm):
        # Deleting model 'BlacklistedDomain'
        db.delete_table(u'djangofeeds_blacklisteddomain')


    models = {
        u'djangofeeds.blacklisteddomain': {
