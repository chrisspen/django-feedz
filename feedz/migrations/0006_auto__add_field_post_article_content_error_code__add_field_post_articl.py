...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.article_content_error_code'
        db.add_column(u'djangofeeds_post', 'article_content_error_code',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.article_content_error_reason'
        db.add_column(u'djangofeeds_post', 'article_content_error_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.article_content_error_code'
        db.delete_column(u'djangofeeds_post', 'article_content_error_code')

        # Deleting field 'Post.article_content_error_reason'
        db.delete_column(u'djangofeeds_post', 'article_content_error_reason')
