...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Post', fields ['article_content_success']
        db.create_index(u'djangofeeds_post', ['article_content_success'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['article_content_success']
        db.delete_index(u'djangofeeds_post', ['article_content_success'])
