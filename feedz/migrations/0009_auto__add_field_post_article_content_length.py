...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.article_content_length'
        db.add_column(u'djangofeeds_post', 'article_content_length',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.article_content_length'
        db.delete_column(u'djangofeeds_post', 'article_content_length')
