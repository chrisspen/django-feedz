...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.article_ngrams_extracted_datetime'
        db.add_column(u'djangofeeds_post', 'article_ngrams_extracted_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.article_ngram_counts'
        db.add_column(u'djangofeeds_post', 'article_ngram_counts',
                      self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.article_ngrams_extracted_datetime'
        db.delete_column(u'djangofeeds_post', 'article_ngrams_extracted_datetime')

        # Deleting field 'Post.article_ngram_counts'
        db.delete_column(u'djangofeeds_post', 'article_ngram_counts')
