...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Post', fields ['date_published']
        db.create_index(u'djangofeeds_post', ['date_published'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['date_published']
        db.delete_index(u'djangofeeds_post', ['date_published'])
    ...
    models = {
        ...
        'djangofeeds.articlebydomain': {
            'Meta': {'ordering': "('-year', '-month', '-missing_without_error', '-missing_ratio')", 'object_name': 'ArticleByDomain', 'managed': 'False'},
            'domain': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'primary_key': 'True'}),
            'missing': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'missing_ratio': ('django.db.models.fields.FloatField', [], {}),
            'missing_without_error': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'missing_without_error_or_success': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'missing_without_error_or_success_ratio': ('django.db.models.fields.FloatField', [], {}),
            'missing_without_error_ratio': ('django.db.models.fields.FloatField', [], {}),
            'month': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'total': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'year': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        ...
        'djangofeeds.post': {
            ...
            'article_ngram_counts': ('picklefield.fields.PickledObjectField', [], {'null': 'True', 'blank': 'True'}),
            'article_ngrams_extracted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'article_ngrams_extracted_datetime': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['djangofeeds.Category']", 'symmetrical': 'False'}),
            'content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'date_published': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
